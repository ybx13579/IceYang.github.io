...
## 峰智谦成教育 （ 2019年9月 ~ 至今 ）
### 前言
近期项目为中小学生在线答题的页面，当前主要要求压缩代码体积，减少冗余，前后端分离
### 项目
<ul>
    <li>
        <h4>1、青少年宪法答题活动<span>2019-09-110至 至今</span></h4>
        <ul>
            <li>公众号的网页，验证登录、答题选项提示、上一题、投诉、抽奖</li>
            <li>要求减少代码冗余，答题项目使用期间日均访问量在400万左右</li>
        </ul>
    </li>
    <li>
        <h4>2、答题统计后台<span>2018-09-18至2018-09-25</span></h4>
        <ul>
            <li>小火苗热度排序、echarts热力图显示、各种图表，还未写登录</li>
        </ul>
    </li>
</ul>
...
## 容言 （ 2018年5月 ~ 2019年5月 ）
### 前言
公司在望京SOHO，是一家医美咨询服务类公司，创业团队，技术开发团队总共4人，除了各司其职，大家也经常性沟通需求，交流想法。来公司后做的大项目有官网、容言后台、言语小程序及各类活动页的制作。
### 项目
<ul>
    <li>
        <h4>1、容言活动页<span>2018-05-16至 至今</span></h4>
        <ul>
            <li>各节日、活动类活动页的制作</li>
        </ul>
    </li>
    <li>
        <h4>2、容言官网（PC+移动）<span>2018-05-18至2018-05-25</span></h4>
        <ul>
            <li>网址：<a target="_blank">www.rongyan.ren</a></li>
        </ul>
    </li>
    <li>
        <h4>3、容言小程序<span>2018-06-04至 至今</span></h4>
        <ul>
            <li>功能：客服会话、付费、上传图片、预览保存图片、上传视频、打卡、生成报告、地理位置获取、消息推送…</li>
        </ul>
    </li>
    <li>
        <h4>4、公众号小游戏<span>2018-06-04至 2018-07-03</span></h4>
        <ul>
            <li>功能：上传、裁切、生成图片，canvas画图…</li>
        </ul>
    </li>
    <li>
        <h4>5、院方资料上传-院方端<span>2018-07-10至 2018-07-</span></h4>
        <ul>
            <li>简介：合作方机构各种资料的在线填写与上传…</li>
        </ul>
    </li>
    <li>
        <h4>6、容言后台管理<span>2018-07-18至 至今</span></h4>
        <ul>
            <li>简介：公司各项业务的后台管理…</li>
            <li>功能：搜索框模糊搜索、文件上传、编辑列表、大条件筛选列表、区域地图划分…</li>
        </ul>
    </li>
</ul>
